...
transforms=${base}/llvm-project-mutated/llvm/lib/Transforms
compilation_db=${base}/llvm-project-mutated/build/compile_commands.json
info_path=${base}/llvm-project-mutated/llvm/mutation_info
