...
/* ------------------------------------------ */
/* 
 * reads : g_2 g_5 g_9 g_14 g_4 g_18
 * writes: g_4 g_5 g_2 g_9 g_14 g_18
 */
static uint8_t  func_1(void)
{ /* block id: 0 */
    ...
    for (g_5 = 0; (g_5 != 35); g_5 = safe_add_func_int32_t_s_s(g_5, 7))
    { /* block id: 6 */
        --g_9;
        g_14--;
        if (g_4)
